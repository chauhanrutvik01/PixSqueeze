...
export async function generateMetadata({ params }: { params: Promise<{ slug: string }> }): Promise<Metadata> {
  ...
  const title = `Compress Image to ${page.label} Free Online — No Upload`;
  const description = `Compress image to ${page.label} free with private, no-upload processing. Reduce JPG, PNG, WebP and HEIC files online in your browser.`;
  return {
    title,
    description,
